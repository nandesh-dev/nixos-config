  ...
  units = [
    ...
    }
    {
      ...
      run =
        { ... }:
        {
          xdg.configFile."wallpaper.jpg".source = ./.config/wallpaper.jpg;
        };
      config = ''
    ...
    }
    {
      ...
      config = ''
        exec --no-startup-id xss-lock --transfer-sleep-lock -- betterlockscreen -u ~/.config/wallpaper.png -l dim --desc "Welcome Back!"
      '';
    }
    {
      name = "dmenu";
